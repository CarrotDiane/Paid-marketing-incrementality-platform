...
create or replace table sandbox_db.dianedou.OTT_synthetic_control_cohort_vprod_temp as
  ...
  , control_cohort_base as (
    ...
    , 0 as variant
    from (select * from control_cohort_base sample(10)) base
;
...
create or replace table sandbox_db.dianedou.OTT_synthetic_new_user_base_table_vprod_temp as
...
set user_base_table = 'sandbox_db.dianedou.OTT_synthetic_new_user_base_table_vprod_temp';
...
CREATE OR REPLACE table sandbox_db.dianedou.OTT_new_user_matching_attributes_vprod_temp as
